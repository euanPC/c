...
import e.procedure.ProcedureUyfuyf;
...
public class GuiLabg extends ElementsCocMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiLabg(ElementsCocMod instance) {
		super(instance, 3);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 88, 8) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(Items.PAPER, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 16, 62) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				CocMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("coc:textures/labg.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("paper", 114, 7, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 12, this.guiTop + 35, 50, 20, "start"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			CocMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 3 && changeType == 1) {
			{
				...
				ProcedureUyfuyf.executeProcedure($_dependencies);
			}
		}
